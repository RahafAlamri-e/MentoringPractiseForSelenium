...
public class C08GoogleSearchTest {
    ...
    By resultStatsId = By.id("result-stats");
...
//        driver.findElement(By.xpath("//div[.='Tout accepter']")).click();
    ...
    public void searchMovies() throws InterruptedException {
        ...
        for(String movie : movies) {
            ...
            driver.findElement(searchBoxName).clear();

            // TODO: Clear and enter movie name
            // TODO: Submit search
            driver.findElement(searchBoxName).sendKeys(movies[0], Keys.ENTER);
            Thread.sleep(10000);

            // TODO: Get and print result count
            String resultText = driver.findElement(resultStatsId).getText();
